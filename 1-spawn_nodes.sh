...
##openstack --os-cloud=limestone --os-region=us-dfw-1 server create --image 'Fedora-Cloud-Base-35-1.2.x86_64-20211108' --wait --flavor c1.hwetest.1 --network "Public Internet" --key-name goneri mirror
openstack --os-cloud=limestone --os-region=us-slc server create --image 'Fedora-Cloud-Base-35-1.2.x86_64-20211108' --wait --flavor r1.tiny --network "Public Internet" --key-name goneri mirror
